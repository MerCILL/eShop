...
public class CatalogBrandServiceTests
{
    ...
    public async Task Get_ReturnsMappedCatalogBrands_WhenRepositoryReturnsEntities()
    {
        ...
        {
            new CatalogBrand { Id = 1, Title = "Brand1", CreatedAt = DateTime.UtcNow, UpdatedAt = null},
            new CatalogBrand { Id = 2, Title = "Brand2", CreatedAt = DateTime.UtcNow, UpdatedAt = null}
        };
